...
class Action {
    ...
    addColumn(columnOptions, index) {
        let addColumn = createInstance(Columns, [this.parent, 'columns', columnOptions, true]);
...
class Crud {
    ...
    getIndexFromData(data) {
        let cardElement = this.parent.element.querySelector(`.${CARD_CLASS}[data-id="${data[this.parent.cardSettings.headerField]}"]`);
        let element = closest(cardElement, '.' + CONTENT_CELLS_CLASS);
        let index = [].slice.call(element.querySelectorAll('.' + CARD_CLASS)).indexOf(cardElement);
        return index;
    }
    ...
    getDialogContent(args, action) {
        if (action === 'Delete') {
            ...
            if (this.parent.dialogSettings.template) {
                ...
                let dialogTemplate = this.parent.templateParser(this.parent.dialogSettings.template)(args, this.parent, 'dialogTemplate', templateId, false);
...
class LayoutRender extends MobileLayout {
        ...
        for (let column of this.parent.columns) {
            if (this.isColumnVisible(column)) {
                ...
                if (column.template) {
                    ...
                    let templateHeader = this.parent.templateParser(column.template)(templateArgs, this.parent, 'columnTemplate', templateId, false);
    ...
    renderSwimlaneRow(tBody, row, isCollapsed) {
        ...
        if (this.parent.swimlaneSettings.template) {
            ...
            let swimlaneTemplate = this.parent.templateParser(this.parent.swimlaneSettings.template)(templateArgs, this.parent, 'swimlaneTemplate', templateId, false);
    ...
    renderCard(data) {
        ...
        if (this.parent.cardSettings.template) {
            ...
            let cardTemplate = this.parent.templateParser(this.parent.cardSettings.template)(data, this.parent, 'cardTemplate', templateId, false);
