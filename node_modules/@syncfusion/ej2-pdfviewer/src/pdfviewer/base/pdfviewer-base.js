...
var PdfViewerBase = /** @class */ (function () {
    ...
    PdfViewerBase.prototype.downloadDocument = function (blobUrl) {
        ...
        if (anchorElement.click) {
            ...
            if ('download' in anchorElement) {
                // tslint:disable-next-line:max-line-length
                anchorElement.download = this.pdfViewer.downloadFileName ? this.pdfViewer.downloadFileName : this.pdfViewer.fileName;
            }
    ...
    PdfViewerBase.prototype.createRequestForDownload = function () {
        var proxy = this;
        var downloadFileName = proxy.pdfViewer.downloadFileName ? proxy.pdfViewer.downloadFileName : proxy.pdfViewer.fileName;
